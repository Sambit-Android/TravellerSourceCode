...
public class DBUnit {
	...
	private static String DATABASE_NAME = dir+ "/CESC_IP/UNIT.db";
	public static final String TABLE_NAME = "UNIT";
	public static final String  COLUMN_ID = "ID";
	public static final String  COLUMN_UNIT_NAME = "COLUMN_UNIT_NAME";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			db.execSQL("create table "+TABLE_NAME+" ("+COLUMN_ID+" integer primary key, "+COLUMN_UNIT_NAME+" text UNIQUE, "+COL_MOB_STATUS+" text)");
			try {
	...
	public boolean addunit(String circlename)
	{
	ContentValues initialValues = new ContentValues();
	initialValues.put(COLUMN_UNIT_NAME, circlename);
	...
	public Cursor getOfflineUnits(){
		String[] columns = new String[] {COLUMN_UNIT_NAME, COL_MOB_STATUS};
