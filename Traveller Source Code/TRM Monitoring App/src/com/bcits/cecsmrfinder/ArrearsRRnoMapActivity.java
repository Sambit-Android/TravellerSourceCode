...
public class ArrearsRRnoMapActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Marker hamburg = map.addMarker(new MarkerOptions()
					...
					.snippet(
							getIntent().getStringExtra("consumer_sc_no")
									+ ","
									+ getIntent().getStringExtra("bill_month")
									+ ",Rs. "
									+ getIntent().getStringExtra("arrears")
									+ ","
									+ getIntent().getStringExtra(
											"consumer_name")
									+ ","
									+ getIntent()
											.getStringExtra("reading_date")
					/* + ","+ obj.getString("mobile") */)
					.icon(BitmapDescriptorFactory
							.fromResource(R.drawable.homeiconblue))
					.draggable(false));
			...
			map.setInfoWindowAdapter(new InfoWindowAdapter() {
				...
				public View getInfoContents(Marker arg0) {
					...
					View v = getLayoutInflater().inflate(
							R.layout.custom_arrearno_info, null);
					...
					TextView tvlati = (TextView) v.findViewById(R.id.info5);
					TextView tvrdngdt = (TextView) v
							.findViewById(R.id.infordngdt);

					tvType.setText(arg0.getSnippet().split(",")[0].trim()
							.equals(null) ? "-"
							: arg0.getSnippet().split(",")[0].trim());
					tvfeeder.setText(arg0.getSnippet().split(",")[3]
							.equals(null) ? "-"
							: arg0.getSnippet().split(",")[3]);
					tvlat.setText(arg0.getSnippet().split(",")[1].equals(null) ? "-"
							: arg0.getSnippet().split(",")[1]);
					tvlati.setText(arg0.getSnippet().split(",")[2].equals(null) ? "-"
							: arg0.getSnippet().split(",")[2]);
					tvrdngdt.setText(arg0.getSnippet().split(",")[4]
							.equals(null) ? "-"
							: arg0.getSnippet().split(",")[4]);
					return v;
				}
			});
