...
public class PaymentDetailsLVAdapter extends BaseAdapter {
	...
	public PaymentDetailsLVAdapter(Context contxt) throws JSONException {
		// TODO Auto-generated constructor stub
		
		context = contxt;
		arr = new JSONArray(ConsumerHistoryAllDetails.responsefromserverpaymentdetails);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		rowView = inflater.inflate(R.layout.consumer_history_payment_details_singleitem, null);
		...
		try {
			...
			holder.netamt.setText(arr.getJSONObject(position).getString("TOWARDS"));
