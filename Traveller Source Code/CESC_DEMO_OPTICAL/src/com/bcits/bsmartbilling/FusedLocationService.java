...
/*	private static final long INTERVAL = 1000 * 30;
	...
	private static final long ONE_MIN = 1000 * 5;
	private static final long REFRESH_TIME = ONE_MIN * 1;//10 Seconds
	private static final float MINIMUM_ACCURACY = 0.0f;
	...
	public FusedLocationService(Activity locationActivity) {
		...
		//Toast.makeText(locationActivity, "FusedLocationService", Toast.LENGTH_SHORT).show();
	
	

		if (googleApiClient != null) {
			//Toast.makeText(locationActivity, "googleApiClient.disconnect()", Toast.LENGTH_SHORT).show();
		...
		if (googleApiClient != null) {
		//	Toast.makeText(locationActivity, "googleApiClient.connect()", Toast.LENGTH_SHORT).show();
	...
	//	Toast.makeText(locationActivity, "onConnected", Toast.LENGTH_SHORT).show();
	...
	public void onLocationChanged(Location location) {
		...
		//Toast.makeText(locationActivity, "onLocationChanged", Toast.LENGTH_SHORT).show();
	...
	public void onConnectionFailed(ConnectionResult connectionResult) {
		//Toast.makeText(locationActivity, "onConnectionFailed", Toast.LENGTH_SHORT).show();
	}
}
