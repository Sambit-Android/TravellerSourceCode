...
public class CameraActivity extends Activity {
	...
	public static boolean isTakenPhoto=false;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if( (UtilMaster.mGLogin_MRCode.equalsIgnoreCase("")) ||  UtilMaster.mGLogin_SiteCode.equalsIgnoreCase("") ){
			...
			if(UtilMaster.isPhotoEnable()){ //TODO
				System.out.println(isTakenPhoto+" isTakenPhoto=====OUTSIDE======");

				if(isTakenPhoto && CustomCamera.getImageByteArray()!=null)
				{
					System.out.println(isTakenPhoto+" isTakenPhoto=======INSIDE===="+ CustomCamera.getImageByteArray());
					...
					/*if(CustomCamera.getImageByteArray()==null)
					{

					}*/
					//isTakenPhoto=false;
					
					String imagename = UtilMaster.getmGLogin_SiteCode() + "_" + UtilMaster.getmGLogin_MRCode() + "_"+ UtilMaster.mconsumer_sc_no;
					CustomCamera.openCamera(CameraActivity.this, CameraActivity.class, imagename);
					isTakenPhoto=true;
		...
		try {
			...
			if(Ltariff_code_i == 1  || Ltariff_code_i == 111 || Ltariff_code_i == 112 || Ltariff_code_i == 113 || Ltariff_code_i == 114  )
			{
				...
				if ((!(UtilMaster.getMpresentmeterstatus().equals("1") || UtilMaster.getMpresentmeterstatus().equals("5")))
					...
					System.out.println("Coming hereeeeeeeeeeeeeeeeeeeeeeeeeeeGGGGGGGGGGGGGGGGGG");
	...
	private void calculationOtherThenNormal() throws Exception {
		...
		/*else if(UtilMaster.getMpresentmeterstatus().equals("2") || UtilMaster.mpreviousreadingstatus.equals("2"))*/
		{
			...
			// MODIFIED ON 05-04-2016 REMOVED METERCONST
	...
	private void move_inten( Context context , Class class1 ) {
		Intent intent = new Intent(context,class1);
		//	mEnabled=false;      
		startActivity(intent);
	}
	private android.content.DialogInterface.OnClickListener getDialogListener(
