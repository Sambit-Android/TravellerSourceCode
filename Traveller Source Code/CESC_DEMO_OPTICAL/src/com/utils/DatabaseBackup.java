...
public class DatabaseBackup {
	...
	static Logger logger ;
	 private static String TAG = "DatabaseHandlerBackup";
	static File dir = new File(Environment.getExternalStorageDirectory() + "");
	
	
	private static String MYDATABASE_NAME = dir + "/GESCOM/GULBARGAELECTRICITYBOARD_BACKUP.db";// dir+"/
...
+KEY_EXTRA8+		"  text  );" ;
	...
	public void insert(List<BackupHelper> bList ) {
		...
		logger.debug("insert");
		logger.debug("backupdb_status" + db_status);
			...
			if (db_status) {
				...
				/*if (mCursor != null && mCursor.moveToFirst()) {
					...
					System.out.println("step 2************************************************************");
					 ...
					 logger.debug("Inside the 1st block of backup insertion for consumer number: "+backupHelper.mbconsumer_sc_no);
				...
				/*}*/
				 ...
				 logger.debug("Inside the 2nd block of backup insertion for consumer number: "+backupHelper.mbconsumer_sc_no);
