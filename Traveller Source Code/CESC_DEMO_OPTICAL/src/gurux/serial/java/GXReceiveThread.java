...
{     
            ...
            {                
                ...
                {                    
                    ...
                    {                                
                        ...
                        {
                            totalCount = GXSynchronousMediaBase.indexOf(Buffer, GXSynchronousMediaBase.getAsByteArray(eop), BufferPosition - len, BufferPosition);
                            if (totalCount != -1)
                            {
                                break;
                            }
    ...
    */
    ...
    {         
        ...
        {
        	// Utils.dirctLogcat(String.valueOf("READING THREAD GXRECEIVE THREAD")); 
            try
            {   //TODO
            	...
            	len = MainActivity.mSerial.read(buff);
            	buff[len] = 0;
              ...
              //  Utils.dirctLogcat(String.valueOf(tempByte.length+" LENGTH  ---------   BYTE[]   "+GXDLMSClient.toHex(tempByte))); 
                handleReceivedData(tempByte);
                }
                }
            catch(Exception ex)
            { 
            	Utils.dirctLogcat("RECEIVING THREAD EXCEPTION  "+ex.getMessage()); 
