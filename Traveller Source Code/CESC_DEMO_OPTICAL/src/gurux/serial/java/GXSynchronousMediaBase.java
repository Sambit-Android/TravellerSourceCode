...
class GXSynchronousMediaBase
{
    ...
    */
    ...
    { //TODO
    //	Utils.dirctLogcat("receive(ReceiveParameters<T> args");
        if (args.getEop() == null && args.getCount() == 0)
        {
        	Utils.dirctLogcat("Either Count or Eop must be set.");               
        }
        int nSize = 0;
        ...
        {            
            ...
            {
            	Utils.dirctLogcat("Invalid reply type");
                throw new RuntimeException();
            }
        }
    //    Utils.dirctLogcat("receive(ReceiveParameters<T> args ===============================  "+retValue);
        return retValue;
    }
}