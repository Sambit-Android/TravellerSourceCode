...
import gurux.common.MediaState;
  ...
  /*  @Override 
    ...
    */
    ...
    {//TODO
     ...
     //   Utils.dirctLogcat(String.valueOf("<<<  "+GXDLMSClient.toHex(buff))); 
        
        MainActivity.mSerial.write(buff, buff.length);
    ...
    */
    ...
    {        
        ...
        try
        {
        	...
        	System.out.println(m_PortName+" **************MPortName***********************");
...
//            	m_hWnd = NativeCode.openSerialPort(m_PortName, tmp); 
            	m_hWnd = (UsbRecieverService.usbConnected)?1:0;      //TODO CHECKING MSERIAL OPENED
            	Utils.dirctLogcat(m_hWnd +"  m_hWnd INT VALUE");
			} catch (Exception e) {
			e.printStackTrace();
			}
            ...
            finally
            {
                try
                {
                   // NativeCode.closeSerialPort(m_hWnd, m_Closing);
                	//closing usb port in Mainactivitiy - ReadMter -postexecute
                }
  ...
  */ 
    ...
    */
    ...
    public final void validate()
    {
        ...
        {
            throw new RuntimeException("SoTest");
        }
    }
