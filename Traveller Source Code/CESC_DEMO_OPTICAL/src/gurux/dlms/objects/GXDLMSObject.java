...
//    }
     ...
     String []shortNameArray={"0.0.1.0.0.255","0.0.96.1.0.255","1.0.1.8.0.255","1.0.32.7.0.255","0.0.96.7.0.255","0.0.0.1.0.255","0.0.94.91.0.255","0.0.13.0.0.255"};
    public final Object getName()
    {
        for(int i=0;i<shortNameArray.length;i++){
        if(getLogicalName().equals(shortNameArray[i]))
