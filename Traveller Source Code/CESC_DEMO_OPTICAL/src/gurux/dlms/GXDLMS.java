    ...
    */
            ...
            boolean[] wrongCrc, int[] command)
    {
        ...
        if (getInterfaceType() != InterfaceType.NET)
        {
            ...
            if (MoreData.isEmpty() && buff.get(FrameLen + PacketStartID + 1) != GXCommon.HDLCFrameStartEnd && !MainActivity.meterName .equals("SECURE"))                
            {//TODO
            	Utils.dirctLogcat(  "Invalid data format."); 
                throw new GXDLMSException("Invalid data format.");
        ...
        else
        {
            ...
            if (ver != 1)
            {
            	Utils.dirctLogcat("Unknown version."); 
        ...
        if (!GXCommon.compare(buff, ClientBuff))
        {
            ...
            Utils.dirctLogcat("Source addresses do not match. It is " + 
        ...
        {
            int tmp[] = new int[]{buff.position()};
            Utils.dirctLogcat("Destination addresses do not match. It is " + 
