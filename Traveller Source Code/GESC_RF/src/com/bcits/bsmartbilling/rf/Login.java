...
public class Login extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			startService(new Intent(Login.this,UsbRecieverService.class)); // START USB SERVICE //TODO
	...
	protected void onStart() {
		...
		alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), 10*6*10000, pendingIntent);
