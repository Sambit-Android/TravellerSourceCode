...
import com.bcits.bsmartbilling.rf.MainActivity.TimeCheckTask;
...
public class MyAlarmService extends Service {
	...
	public void onStart(Intent intent, int startId) {
	 ...
	 System.out.println("**************Came to onstart of the Myalarmservice**************");
	...
	public class performBackgroundTaskupload extends AsyncTask<Void, Void, Void> 
	{
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				System.out.println("******************BackgroundService Update is executing******************");
