...
public class SearchActivity extends Activity {
	...
	/*	if(UtilMaster. mbilledstatus.equalsIgnoreCase("1") ){
		...
		else
		{
			...
			RfLibMain.readMeter(SearchActivity.this, AmrBiller.class, MainActivity.class, UtilMaster.getMmeterno(),UtilMaster.getMarrears(), false);
//			Toast.makeText(getApplicationContext(), UtilMaster.getMmeterno(), Toast.LENGTH_SHORT).show();
