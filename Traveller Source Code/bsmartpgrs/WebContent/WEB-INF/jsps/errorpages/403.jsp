			...
			<div class="row">
				<div class="col-sm-12">
					<div class="text-center error-box">
						<h4 class="error-text-2 bounceInDown animated"> Access Denied <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h4>
						<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> UnAuthorised To Access</strong></h2>
						<br />
						<p class="lead">
							The page you requested could not be accessed, either contact your administrator or try again. Use your browsers <b>Back</b> button to navigate to the page you have prevously come from
						</p>
						<p class="font-md">
