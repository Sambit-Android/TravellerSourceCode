...
<script src="./resources/js/plugin/jquery-validate/jquery.validate.min.js"></script>
											 ...
											 <article class="col-sm-12 col-md-12 col-lg-7">
												...
												<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
													...
													<div>
														<!-- widget content -->
														<div class="widget-body no-padding">
															<form:form action="./fieldVerifactionInsert" method="post" id="fieldVerfication-form" class="smart-form" commandName="FieldVerification" modelAttribute="fieldVerfication" enctype="multipart/form-data" autocomplete="off">
																<fieldset>
																	<div class="row">
																		...
																		<section class="col col-6">
																			...
																			<label class="input">
																				<form:input type="text"	name="polenumber" placeholder="Pole Number" path="polenumber" id="polenumber" autocomplete="off"></form:input>
																			</label>
																		</section> 
																	</div>
																	...
																	<div class="row">
																		...
																		<section class="col col-6">
																			...
																			<label class="input"> <i class="icon-append fa fa-calendar"></i>
																				<form:input type="text"	name="fvdate" placeholder="Field Verification Date" path="fvdate" id="fvdate" autocomplete="off"></form:input>
																			</label>
																		</section>
																  ...
																  <div class="row" id="showthisforLTApplication">
																	...
																	<label class="label">Documents&nbsp;<font color="red">*</font></label>
																		<div class="input input-file">
																			<span class="button"><input id="file" type="file" name="file" onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input type="text" id="fileid" name="fileid" placeholder="Field Verification Document (Pdf,Image,Excel and Word)" readonly="" autocomplete="off">
																		</div>
																	</section>
																	...
																	<label class="label">Upload Document&nbsp;</label>
																		<div class="input input-file">
																			<span class="button"><input id="file1" type="file" name="file1" onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input type="text"
													                         placeholder="Upload Document" id="docText" autocomplete="off">
																		</div>
																	</section>
		...
		<div id="addtab" title="Timeline/Log Details" style="display:none">
         ...
         <div id="addtabforClarifications" title="Clarifications" style="display:none">
    	    <table class="table table-bordered table-striped">
			 <thead>
				 <tr>
		 ...
		 if(tariffMain=='LT'){
			...
			$.validator.addMethod("dateFormat",
			 ...
			 $('#fieldVerfication-form').validate({
					// Rules for form validation
						...
						messages : {
							...
							polenumber:{
								...
								regex:'Please enter valid pole number',
							},
			    ...
			    /* var tariffType=document.getElementsByClassName('tariffmain')[0].innerHTML;
