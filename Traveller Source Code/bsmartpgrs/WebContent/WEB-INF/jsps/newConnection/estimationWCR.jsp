...
<div id="content">
	...
	<div class="row"
		style="margin-top: 5px; margin-left: 5px; margin-right: 5px; margin-bottom: 9px;">

		<div class="col-sm-4">
			<a class="btn bg-color-orange btn-lg txt-color-white"
				id="redirectData2" style="width: 350px;">In Progress </a>
		</div>

		<div class="col-sm-4">
			<a class="btn bg-color-greenLight btn-lg txt-color-white"
				id="redirectData3" style="width: 350px;">Completed </a>
		</div>

		<div class="col-sm-4">
			<a class="btn bg-color-redLight btn-lg txt-color-white"
				id="redirectData4" style="width: 350px;">On Hold</a>
		</div>
				...
				<header>
					...
					<ul class="nav nav-tabs pull-right in" id="myTab">
						...
						<li class="active"><a data-toggle="tab" href="#s9"><i
								class=""></i> <span class="hidden-mobile hidden-tablet">WCR</span></a>
						</li>
														...
														Division&nbsp;&nbsp;&nbsp;:&nbsp;<b><font color="red">${subdivisionText}</font>&nbsp;&nbsp;
															...
															<c:if test="${element.applicationtype =='Multiple Connection' || element.applicationtype =='MS Building'}">
																<a class="btn bg-color-pinkDark txt-color-white"
																	style="width: 180px;"
																	onclick="return viewSubConnection(${applicationId});"
																	title="View multiple connections for MS Building/Multiple Connection">
																	<font size="2"><b>View Connections</b></font>
																</a> &nbsp;&nbsp;
																	
															</c:if> <input type="button" value="View Application"
									...
									<div class="jarviswidget" id="wid-id-1"
										...
										<div>
											...
											<div class="widget-body no-padding">
												<form:form id="wcr-form" action="./wcrInsert"
													commandName="Wcr" modelAttribute="wcr" class="smart-form"
													...
													<fieldset>
														<div class="row">
															...
															<section class="col col-4">
																<label class="label">Work Completion Ref
																	Number&nbsp;<font color="red">*</font>
																</label> <label class="input"> <form:input type="text"
																		name="wcrrefno" id="wcrrefno" path="wcrrefno"
																		placeholder="Work Completion Ref Number"
																		onchange="checkduplicate()" autocomplete="off" />
																</label>
															</section>
															<section class="col col-4">
																<label class="label">Work Completion Date&nbsp;<font
																	color="red">*</font></label> <label class="input"> <i
																	class="icon-append fa fa-calendar"></i> <form:input
																		type="text" name="wcrdate" id="wcrdate" path="wcrdate"
																		placeholder="Work Completion Date" autocomplete="off" />
																</label>
															</section>
														...
														<div class="row">
															<section class="col col-3">
																<label class="label">Work Commencement
																	Date&nbsp;<font color="red">*</font>
																</label> <label class="input"> <i
																	class="icon-append fa fa-calendar"></i> <form:input
																		type="text" name="wosdate" id="wosdate" path="wosdate"
																		placeholder="Work Commencement Date"
																		autocomplete="off" />
																</label>
															</section>
															...
															<section class="col col-4">
																...
																<div class="input input-file">
																	<span class="button"><input id="file"
																		...
																		placeholder="Work Completion Document" readonly=""
																		autocomplete="off">
																</div>
															</section>
															
															<section class="col col-5">
															<label class="label">Electrical
																&nbsp;Inspection&nbsp;Report&nbsp;
															</label>
															<div class="input input-file">
																<span class="button"><input id="file2"
																	type="file" name="file2"
																	onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input
																	type="text" id="fileid1" name="fileid1"
																	placeholder="Electrical  Inspection Report" readonly
																	autocomplete="off">
															</div>
														</section>
		...
		<tbody>
			...
			<c:forEach var="workOrder" items="${workOrderServiceDetails}">
				<tr>
					<td>Work Order</td>
					<td>${workOrder.worefno}</td>
					<td class="wodate"><fmt:formatDate
							value="${workOrder.wocdate}" pattern="dd-MM-yyyy" /></td>
			...
			<c:forEach var="meterPro" items="${meterProServiceDetails}">
				<tr>
					<td>Meter Po</td>
					<td>${meterPro.porefno}</td>
					<td class="mpodate"><fmt:formatDate value="${meterPro.podate}"
							pattern="dd-MM-yyyy" /></td>
				</tr>
...
<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(response) {
					...
					if (response == "NF") {
						...
						alert("Reference No already registered");
						$("#wcrrefno").val(" ");
					}
				}
			});
		...
		$(document).ready(function() {
			...
			var $checkoutForm = $('#wcr-form').validate({
			// Rules for form validation
				...
				messages : {
					...
					wcrdate : {
						required : 'Select Work Completion  Date',
						
					},
					wcrrefno : {
						required : 'Enter WCR Ref. Number',
						regex:'Please Enter Valid Reference No.',
					},
					wosdate : {
						required : 'Select Work Commencement  Date',
			...
			$("#wcrdate").datepicker("option","minDate",minDate );
			...
			var month=(parseFloat(monlast))-1;					   
			var minDate=new Date(year,month,date);					
			$("#wosdate").datepicker("option","minDate",minDate );
