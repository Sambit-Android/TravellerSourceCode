...
<section id="widget-grid" class="">
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-28"
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<table id="datatable_fixed_column"
							...
							<tbody>
								<c:forEach var="app" items="${meterCapacityDetails}">
									<tr>

										<td>${app.metercapacity}</td>
										<td>${app.username}</td>
										<td>
										<fmt:formatDate value="${app.datestamp}" pattern="dd-MM-yyyy"/>
										</td>
