							...
							<div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
								...
								<header>
									...
									<ul class="nav nav-tabs pull-right in" id="myTab">
										...
										<li>
											<a data-toggle="tab" href="#s15"><i class=""></i> <span class="hidden-mobile hidden-tablet">FV Acceptance</span></a>
										</li>
										
										<li>
											<a data-toggle="tab" href="#s5"><i class=""></i> <span class="hidden-mobile hidden-tablet">Power Sanction</span></a>
										</li> 
										...
										<li>
											<a data-toggle="tab" href="#s7"><i class=""></i> <span class="hidden-mobile hidden-tablet">WO</span></a>
										</li> 
										<li>
											<a data-toggle="tab" href="#s8"><i class=""></i> <span class="hidden-mobile hidden-tablet">Meter/PC Test</span></a>
										</li> 
										
										<li>
											<a data-toggle="tab" href="#s9"><i class=""></i> <span class="hidden-mobile hidden-tablet">WCR</span></a>
										</li>
										<li class="active">
											<a data-toggle="tab" href="#s10"><i class=""></i> <span class="hidden-mobile hidden-tablet">Service</span></a>
										</li> 
										<li>
											<a data-toggle="tab" href="#s11"><i class=""></i> <span class="hidden-mobile hidden-tablet">Documents</span></a>
										</li> 
	                                          	...
	                                          	<div class="col-sm-6">
														...
														<table class="table table-bordered table-striped">
															...
															<tbody>
																...
																<tr>
																	<th>Estimation Required </th>
																	<td  colspan="2">${element.estmnreq}</td>
																</tr>
																<%-- <tr>
														...
														<table class="table table-bordered table-striped">
															...
															<c:forEach var="estimation" items="${estimationServiceDetails}">
																...
																<c:if test = "${empty estimationServiceDetails}">
																 <fieldset>
																	<h6>&nbsp;&nbsp;&nbsp;&nbsp;Estimation Requirement is not done for this Application</h6>
																 </fieldset>
																 </c:if>
															</tbody>
														</table>
													...
													<div class="col-sm-6">
														...
														<table class="table table-bordered table-striped">
															...
															<c:forEach var="meterPro" items="${meterProServiceDetails}">
																<tr>
																	<th>Meter Purchase Order Ref No.</th>
																	<td>${meterPro.porefno}</td>
																</tr>
																<tr>
																	<th>Meter Purchase Order Date  </th>
																	<td><fmt:formatDate value="${meterPro.podate}" pattern="dd-MM-yyyy"/></td>																	
																</tr>
																<tr>
																	<th>Meter Purchase Order Done By </th>
																...
																<td><b><font color="red">${meterPro.remarks}</font></b></td>
																 ...
																 <fieldset>
																	<h6>&nbsp;&nbsp;&nbsp;&nbsp;Meter Purchase Order is not done for this Application</h6>
																 </fieldset>
																 </c:if>
											 ...
											 <article class="col-sm-12 col-md-12 col-lg-6">
												...
												<div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
													...
													<header>
														...
														<h2>Installation Service Details </h2>				
													</header>
													...
													<div>
														...
														<div class="widget-body no-padding">
															<form:form action="./installationServiceInsert" method="post" id="service-form" class="smart-form"  commandName="service" enctype="multipart/form-data" modelAttribute="service">
																...
																<fieldset>
																	...
																	<div class="row">
																		...
																		<section class="col col-4" id="showNoOfConnections">
																			<label class="label">No Of Connections Required</label>
																			<label class="input">
																				<input type="text" name="connectionNo" id="connectionNo" value="${NoOfConnections}" readonly="readonly">
																			</label>
																		</section>
																	...
																	<div class="row">
																		<section class="col col-6">
																			<label class="label">Installation Service Ref. Number&nbsp;<font color="red">*</font></label>
						                                         			<label class="input">
																				<form:input type="text"	name="servrefno" placeholder="Service Ref Number" path="servrefno" id="servrefno" maxlength="50" autocomplete="off" onchange="checkduplicate()"></form:input>
																			</label>
																		</section>
																		
																		
																		<section class="col col-6">
																			<label class="label">Installation Service Date&nbsp;<font color="red">*</font></label>
																			<label class="input"> <i class="icon-append fa fa-calendar"></i>
																				<form:input type="text"	name="servrdate" placeholder="Service Date" path="servrdate" id="servrdate" autocomplete="off"></form:input>
																	...
																	<section class="col col-12">
																			<table id="allRRNumbers">
																				<a href="#" onclick="addRRNumbers();" style="height: 10px;" id="addrrnoid"><i
																					class=" fa fa-plus-square"></i> <span
																					style="height: 10px; color: green;cursor: pointer;" >Add RR Numbers</span> </a>
																				<tr></tr>
																			</table>
																	</section>
																	</div>
																	 ...
																	 <div class="row" style="display: none;">
																		<section class="col col-6">
																			 <label class="label">RR Number&nbsp;<font color="red">*</font></label>
																			<label class="input">
																				<form:input type="text"	name="rrno" placeholder="RR Number" path="rrno" id="rrno" maxlength="25" autocomplete="off"></form:input>
																			</label>
																		</section>
																	...
																	<section>
																		...
																		<label class="textarea"> 										
																			<form:textarea type="text"	name="remarks" placeholder="Remarks/Comments" path="remarks" id="remarks" maxlength="255"></form:textarea>
																		</label>
																	</section>
																	
																	<section>
																	<label class="label">Installation Service Document&nbsp;</label>
																		<div class="input input-file">																		
																			<span class="button"><input id="file" type="file" name="file" onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input type="text" id="fileid" name="fileid" placeholder="Installation Service Document" autocomplete="off">
																		</div>
																	</section>
																	
																	<section>
																	<label class="label">CR (Completion Report)Document&nbsp;<font color="red">*</font></label>
																		<div class="input input-file">																		
																			<span class="button"><input id="file1" type="file" name="file1" onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input type="text" id="fileid1" name="fileid1" placeholder="CR Document" autocomplete="off">
																		</div>
																	</section>
																...
																<footer>
																	<button type="submit" id="srviceButton" class="btn btn-primary" onclick="return checkData(0);">
																		Submit 
																	</button>
...
<div id="addtab" title="Timeline/Log Details" style="display: none">
		...
		<tbody>
			<c:forEach var="applist" items="${applicationServiceDetailsList}">
				<tr>
					...
					<td><fmt:formatDate value="${applist.appregdate}"
			...
			<c:forEach var="est" items="${estimationServiceDetails}">
				<tr>
					<td>Estimation</td>
					<td>${est.estmnno}</td>
					<td><fmt:formatDate value="${est.estmndate}"
							pattern="dd-MM-yyyy" /></td>
			...
			<c:forEach var="wcr" items="${wcrServiceDetails}">
				<tr>
					<td>Meter Po</td>
					<td>${wcr.wcrrefno}</td>
					<td class="wcdate"><fmt:formatDate value="${wcr.wcrdate}"
							pattern="dd-MM-yyyy" /></td>

				</tr>
				<script>
					var wcrdate=document.getElementsByClassName('wcdate')[0].innerHTML;
	...
	<script type="text/javascript">
		...
		function checkData(param) {
		 ...
		 var rrnoregex = new RegExp("^[0]*[1-9A-Za-z][0-9A-Za-z]*$");
		
		  
		   if(noofconnectionsReq>rrnumberid){
			   alert("Please click on Add RR Numbers for RR No : "+(rrnumberid+1));
			   return false;
		   }
			 
		   for(var i = 1;i<=rrnumberid;i++)
		   {
			   var rrNos = $("#rrnumber"+i).val();
			   if(rrNos=="" || rrNos==null){
				   alert("Please enter RR Number "+i);
				   return false;
			   }
			   /* else if((rrNos!="" || rrNos!=null) &&  (rrNos=='0' || rrNos=='00' || rrNos=='000' || rrNos=='0000' || rrNos=='00000' || rrNos=='000000' || rrNos=='0000000' || rrNos=='00000000' || rrNos=='000000000' || rrNos=='0000000000' || rrNos=='00000000000' || rrNos=='000000000000' || rrNos=='0000000000000')){
				   alert("Please enter Valid RR Number "+i);
				   return false;
			   } */else if (!(rrnoregex.test(rrNos))){
				   alert("Please enter Valid RR Number "+i);
				   return false;
			   }
			   
			   
			   for(var j= i+1;j<=rrnumberid;j++){
			   
				   var rrNos1 = $("#rrnumber"+(j)).val();
				   if (rrNos==rrNos1){
					   alert("Duplicate RR Numbers not allowed");
					   return false;
				   }
		      }
			   
			   rrnumberconcat+=rrNos+",";
		   }
		   
		   var rrnos = rrnumberconcat.replace(/,\s*$/, '');
		   $('#rrno').val(rrnos);
		 ...
		 function addRRNumbers()
		 {
			 
			 rrnumberid++;
			 if(noofconnectionsReq<(rrnumberid+1)){
				 $('#addrrnoid').hide();
			   }
			
			 $('#allRRNumbers').append('<tr id=rrnoData'+rrnumberid+'><td width=265px><label class=label>RR Number '+rrnumberid+' </label> <label class=input><input type=text name=rrnumbers id=rrnumber'+rrnumberid+' placeholder="Enter RR Number" onChange="checkRRNumbersUnique(this.value,'+rrnumberid+');"/><button class=close onclick="return cancelReset(this.name);" name=rrnoData'+rrnumberid+' style="margin-right: -41px;margin-top: -21px;color:red;"><i class="fa fa-times-circle"></i></button></label></td><td><span  id=fileInfo'+rrnumberid+' style="margin-left:30px;"></span></td></tr>');
		 }

		 function checkRRNumbersUnique(rrno,rrnumberid){
			 
			 $.ajax({
					type : "GET",
					url : "./checkRRNumberUniqueness",
					dataType : "text",
					data : {
						rrno : rrno,
					},
		...
		$(document).ready(function() {
           ...
           noofconnectionsReq="${NoOfConnections}";
           
           if(noofconnectionsReq==0){
        	   $('#connectionNo').val('1');
        	   noofconnectionsReq=1;
           }else{
        	   $('#connectionNo').val(noofconnectionsReq); 
           }
           ...
           if(tariffMain=='LT'){
			...
			var $checkoutForm = $('#service-form').validate({
			// Rules for form validation
				...
				messages : {
					...
					rrno : {
						required : 'Enter RR Number',
						maxlength:"Maximum 50 chracter allowed",
						regex:'Please Enter Valid RR No.',
					},
					servrefno : {
						required : 'Enter Installation Service Ref. Number',
						maxlength:"Maximum 50 chracter allowed",
						regex:'Please Enter Valid Reference No.',
					},
					servrdate : {
						required : 'Select Installation Service Date',
			...
			$("#servrdate").datepicker("option","minDate",minDate );
