...
<div id="content">
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			...
			<div class="col-sm-12 ">
				<div class="jarviswidget" id="wid-id-payhis"
					data-widget-editbutton="false" data-widget-custombutton="false">
					<header>
						<span class="widget-icon"><i class="fa fa-search"></i>
						</span>
						<h2>Search Payment History based on RR Number</h2>
			...
			<article class="col-sm-12 ">
					...
					<div class="jarviswidget"
						id="widget-paymenthistory" data-widget-editbutton="false"  data-widget-custombutton="false">
						   ...
						   <header>
							<span class="widget-icon"><i class="fa fa-table"></i>
									...
									<h2>
										Payment History for RR No -<span id="billidspan"></span> <b>
											</b>
									</h2>
...
<script>
	...
	function searchApplicationNo()
	{
	 ...
	 if(rrnumberval=="" || rrnumberval==null){
		 ...
		 var htmldata="";
		 $.ajax({
				url : "./NCMS/getPaymentHostoryByRRNo",
				type : "GET",
				dataType : "JSON",
				async : false,
				data : {
		 ...
		 if(htmldata==""){
				$('#payments').html("<tr><td colspan='6' align='center'>No Record Found</td></tr>");
			}
	 }
