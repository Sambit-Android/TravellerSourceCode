...
<div id="content">				
				<div class="jarviswidget jarviswidget-color-blueDark"  id="gridSupprtTeam" data-widget-editbutton="false" style="display: none;">
								...
								<br><a href='javascript:void(0);' onclick='backToMonth()' class='btn btn-labeled btn-default'> <span class='btn-label'><i class='glyphicon glyphicon-chevron-left'></i></span>Back to My Complaints</a>
								<div>
		...
		<div class="row" id="SupportNumBasedDetailsdsNew">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="jarviswidget jarviswidget-color-blueDark" id="Supportwid-" data-widget-editbutton="false">
								<header>
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
									<h2 id="statusWiseReg123"><span id='outstand'>Outstanding Status of My Registered Complaints</h2>
								</header>
								<div>
									<div class="widget-body no-padding" id="SupportComp">
									   ...
									   <!--      <th data-hide="phone"> Pending For Registration</th> -->
									        ...
									        <th data-hide="phone,tablet">Resolved</th>
									         ...
									         <th data-hide="phone,tablet"> Invalid</th>
								             </tr>
											</thead>
...
function getDateWiseData() {
	...
	var tableData="";
	$('#outstand').html("Outstanding Status of My Registered Complaints ( From : "+fromDate+" To : "+toDate+" )");
	$.ajax({
		type : "POST",
		url : "./readMyComplaintDetails",
		data:{
			fromDate:fromDate,
			toDate:toDate,
			...
			for ( var s = 0, len = response.length; s < len; ++s) {
              	...
              	tableData1 += "<tr>";
              		if(obj.docketStatus=='Resolved'){
	              		...
	              		tableData1+="<td><a style='cursor:pointer;' onclick='docketDetailsValidation("+obj.docketNumber+","+obj.consumerMobileNo+")'>"+obj.docketNumber+"</a></td>";
	              		...
	              		tableData1+="<td><a style='cursor:pointer;' onclick='docketDetailsPopUp("+obj.docketNumber+")'>"+obj.docketNumber+"</a></td>";
	              	}
              		tableData1+="<td>"+obj.docketStatus+"</td>"
	            	...
	            	+"<td>"+obj.assinedName+" - "+obj.assignedTo+" - "+obj.designation+" - "+obj.officialMobileNo+"</td>"
