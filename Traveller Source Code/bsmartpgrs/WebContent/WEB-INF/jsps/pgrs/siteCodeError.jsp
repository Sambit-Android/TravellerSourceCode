						...
						<div class="row">
							<div class="col-sm-12">
								<div class="text-center error-box">
									<h1 class="error-text tada animated"><i class="fa fa-times-circle text-danger error-icon-shadow"></i> Site Code is Blank</h1>
									<br/> 
									<p class="lead semi-bold">
										<strong>Please check with system administrator or Please try again.</strong><br><br>
									</p>
