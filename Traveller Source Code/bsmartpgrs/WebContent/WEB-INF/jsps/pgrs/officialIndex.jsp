						            ...
						            <div class="panel panel-primary pricing-big">
						                ...
						                <div class="panel-heading">
						                    <h3 class="panel-title">
						                        Registered Tickets</h3>
						                </div>
						                <div class="panel-body no-padding text-align-center">
						                    <div class="the-price">
						                        <h1>${registeredTicketsCount}</h1>
						                    </div>
						                </div>
						            </div>
						        </div>	
										...
										<div class="table-responsive">
											...
											<table class="table table-bordered table-striped">
												...
												<tbody>
													...
													<tr>
														<td>Resolved</td>
														<td>Interruption/Failure of power supply</td>
														<td>Line Breakdowns</td>
														<td>Nayana</td>
													</tr>
													<tr>
														<td>In Progress</td>
														<td>Other complaints</td>
														<td>Sag in electrical lines.</td>
														<td>Rakesh</td>
													</tr>
													<tr>
														<td>Registered</td>
