				...
				<div>
					...
					<div class="widget-body no-padding">
						<form:form id="order-form" action="#" method="POST" class="smart-form" novalidate="novalidate">
							<fieldset>
								<div class="row">	
									   <section class="col col-1" id="circleId">
										<label class="radio">
											<input type="radio" name="commonname" value="Circle" id="circleCheck" checked="checked">
											<i></i>Circle</label>
								       </section>
			...
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0"
				...
				<div>
					...
					<div class="widget-body no-padding" id="monthContent" style='overflow-x: scroll;'>
						...
						<div  class="dropzone" id="mydropzone"><center style="padding-top: 10%;"><span style="font-size: 40px; color: #CBCBC5">Generate KERC Consolidated Report By Selecting Month</span></center></div>
					</div>
				</div>
			</div>
		</div>
...
<script>
	...
	function loadData() {
		...
		var x = document.getElementById('circleCheck').checked;
		...
		if(selectedMonth==""){
			...
			$.ajax({
				url : "./reports/KERCTimeLimitReport",
				type : "GET",
				dataType : "JSON",
				async : false,
				data : {
				...
				success : function(response) {
					...
					var htmlTable = "<br><br><div class='monthTabDetail1' style='overflow-x: scroll;'>"
							...
							+ "<thead>"
							+"<tr>"
						    +"<th colspan='14' style='text-align: center; font-size: 18px;'>Chamundeswari Electricity Supply Corporation Ltd, Mysore<br>Location : "+type+"<br> KERC Report <br>Name of State : Karnataka&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Frequency : Monthly<br>Name of Discom : CESC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Selected Month : "+selectedMonth+"</th>"
						    +"</tr>"
							+"<tr>"
					...
					$('#monthContent').html(htmlTable);
					 ...
					 pageSetUp();
						...
						var reportname="KERC Consolidated Report";
