					...
					<div class="row">
						<section class="col col-3">
							...
							<select name="interested">
								...
								<option value="1">Consolidated dashboard of the current status of dockets / complaints</option>
								<option value="2">Complaint status Circle wise to Section  wise</option>
								<option value="3">Major Interruptions and accident reports</option>
								<option value="4">Detailed and Summary Report of Transformer complaints </option>
								<option value="5">Detailed and Summary Report of dockets / complaints resolved</option>
								<option value="6">Detailed and Summary Report of dockets / complaints escalated (Including different level of escalation)</option>
								<option value="7">Detailed and summary report of dockets / complaints logged at Helpdesk (category and sub Category wise)</option>
								<option value="8">Trend analysis of Compliant status Zone wise to Section wise</option>
								<option value="9">Trend analysis of dockets/ complaints which are resolved, unresolved and escalated (at various levels) with respect to response time, resolution time, escalated time</option>
								<option value="10">Trend analysis Average time breached for the dockets / complaints Circle wise to Section wise</option>
								<option value="11">Trend analysis on the performance of complaints and their resolution starting from Circle level to Section level</option>
								<option value="12">Trend analysis of “Customer Satisfaction Results” on various parameters and at different levels (Circle wise to Section wise)</option>
								<option value="13">Time taken to respond to the ticket and to log the ticket </option>
								<option value="14">Number of new incidents/ requests logged</option>
								<option value="15">Number of errors in incident prioritization, categorization, assignment and closure</option>
								<option value="16">Number of complaints solved within/ beyond KERC timelines as per Annexure-2</option>
							</select> <i></i> </label>
							</section>
									<section class="col col-3">
									...
									<section class="col col-2">
										<button type="submit" class="btn btn-primary" style="height: 32px;width: 150px;">Search</button>
									</section>
								</div>
							</fieldset>
						</form>
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
											<thead>
												<tr>
													...
													<th data-class="expand">Consumer Name</th>
													<th>Mobile No.</th>
													<th data-hide="phone">Address</th>
													<th data-hide="phone,tablet">No. Of Tickets</th>
													<th data-hide="phone,tablet">Sub Division</th>
