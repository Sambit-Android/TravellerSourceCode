...
<div id="content">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form:form id="order-form" action="./searchTicket" method="POST" commandName="helpdeskBean" modelAttribute="helpdeskBean" class="smart-form" novalidate="novalidate">
							<fieldset>
								<div class="row">
									...
									<section class="col col-2">
										<label class="select">
											<select name="docketStatus" id="docketStatus">
												...
												<option value="1">Registered&Assigned</option>
	...
	<div id="reopenDiv" title="Reopen complaint" style="display:none">
		...
		<!-- Widget ID (each widget will need unique ID)-->
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
								...
								<a class="btn btn-primary" id="excelExport" href="#" onclick="tableToExcel('datatable_tabletools', 'Search Complaint Report')">Export to Excel</a><br><br>
								<div>
									...
									<div class="widget-body no-padding" style='overflow: scroll;'>
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
											...
											<tr><th colspan="14" style='text-align: center;'>Chamundeswari Electricity Supply Corporation Ltd, Mysore<br>${title}</th></tr>
											</c:if>
												<tr>
											...
											<td><a style="cursor:pointer;" onclick='docketDetailsPopUp(${searchData.docketNumber})'>${searchData.docketNumber}</a></td>
													...
													<td>${searchData.assinedName} - ${searchData.assignedTo} - ${searchData.designation} - ${searchData.officialMobileNo}</td>
...
var str="${title}";
var textWithNBSpaceReplaced = str.replace(/&nbsp;/g, ' ');
var res =textWithNBSpaceReplaced.split("<br>");
var result1=res[0];
var result2=res[1];
var result3=res[2];
var reportname="View Complaints";
									  ...
									  "oTableTools": {
								        	 "aButtons": [
								             
								                {
								                    ...
								                    "sPdfMessage":"                                     Chamundeswari Electricity Supply Corporation Ltd, Mysore                                                                                                                   "+reportname+"                                                                                                                      Location : "+result2+"                                                                                           "+result1+"                                                             "+result3+"",
								                    "sPdfSize": "letter",
