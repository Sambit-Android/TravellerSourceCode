...
public class UserCredentialThroughSMS implements Runnable
{
	...
	public UserCredentialThroughSMS(SmsCredentialsDetailsBean smsCredentialsDetailsBean,String status,String loginUserName,String loginPwd)
	{
	...
	public void run()
	{
		HttpClient client=null;
		 ...
		 post.addParameter("msg", "Dear "+userName+", Your account has been "+status+". Your account details are Login Name : "+loginUserName+" and Password : "+loginPwd+" - CESC-Administration services.");
