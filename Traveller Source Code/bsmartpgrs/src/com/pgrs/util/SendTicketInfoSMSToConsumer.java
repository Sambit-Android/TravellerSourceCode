...
public class SendTicketInfoSMSToConsumer implements Runnable
{
	...
	public SendTicketInfoSMSToConsumer(SmsCredentialsDetailsBean smsCredentialsDetailsBean)
	{
	...
	public void run()
	{
		 ...
		 post.addParameter("msg", "Dear "+userName+", Complaint with docket number "+message+".");
