...
<script type="text/javascript">
  	...
  	function viewMrwiseData()
  	{
  		...
  		$.ajax({
	    	url:'./showCollectionOnMap'+'/'+locCode+'/'+$('#fromDate').val(),
	    	type:'GET',
	    	dataType:'json',
	    	asynch:false,
	    	cache:false,
	    	...
	    	{				
		    	  ...
		    	  for(var i=0;i<response.length;i++)
					{ 
		    		  if(!initialLocation)
		    			  {				 
		    			  if(response[i][9].trim()!=''  || response[i][10].trim()!='')
		    				  {					    				  
		    				     document.getElementById('gmapsContent').style.display='block';
						              ...
						              center: {lat: parseFloat(response[i][9]), lng: parseFloat(response[i][10])},
						              zoom:9,
						          });
		    		...
		    		if(initialLocation)
		    			 {
			              ...
			              infoWindow: {
							  ...
							  +"<tr><th>RR No  </th><td>"+response[i][1]+"</td></tr>"
							  +"<tr><th>Consumer Name   </th><td>"+response[i][8]+"</td></tr>"
							  +"<tr><th>Section    </th><td>"+response[i][11]+"</td></tr>"
							  +"<tr><th>Sdocode   </th><td>"+response[i][7] +"</td></tr>"
							  +"<tr><th>Amount Paid </th><td>"+response[i][2] +"</td></tr>"
							  +"<tr><th>Payment Mode</th><td>"+response[i][4] +"</td></tr>"
							  +"<tr><th>Recipt No. </th><td>"+response[i][3] +"</td></tr>"
							  +"<tr><th>Date and Time </th><td>"+response[i][5] +"</td></tr>"
							  +"</table></div>"
			              }
			          });	
		    			 } 				    		  		    		  
...
<div class="page-content">
	...
	<div class="portlet box blue">
						...
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-reorder"></i>Collection Details on GMAP  </div>   
							<div class="tools">
