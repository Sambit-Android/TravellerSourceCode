...
#onairverupdt label.error {
 ...
 <script  type="text/javascript">
  ...
  function validateForm(){	
		...
		if (validator.form())
		{
			 $("#onairverupdt").attr("action","./addNewVersionUpdateCesc");
  ...
  function downloadAPK(apkid){
	  ...
	  $("form#sprtForm").attr("action","./downloadAPKFileCesc");
	  
	  $("form#sprtForm").submit();
  }
  function releaseAPKVersion(apkid){
	  $("#apkid").attr("value",apkid);
	  $("form#sprtForm").attr("action","./releaseAPKVersionCesc");
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="row">
										<div class="col-md-12">
											<form:form action="./addNewVersionUpdateCesc" modelAttribute="onairverupdtCesc"
																	commandName="onairverupdtCesc" method="post" id="onairverupdt"  enctype="multipart/form-data">
												<table >
													...
													<tr>
														...
														<td><font color="red"></font></td>
														<td><form:select path="remarks" id="remarks" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="" name="remarks" >
																	<form:option  value="">Select</form:option>
																	<form:options items="${remarksList}" />
															</form:select>
														</td>
													</tr>
													...
													<td>App Remarks</td>
													<td><font color="red"></font></td>
													<td><form:textarea path="appRemarks" id="appRemarks"
																class="form-control placeholder-no-fix"
																autocomplete="off" placeholder="" name="appRemarks" ></form:textarea></td>
													</tr>
