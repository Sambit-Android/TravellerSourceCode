...
#rll
{
 ...
 <script  type="text/javascript">
  $(".page-content").ready(function()
   	    	  ...
   	    	  TableEditable.init();
   	    	 FormComponents.init();
   	    	$('#theftRecording').addClass('start active ,selected');
	   	  		$('#dash-board,#user-location,#meterData-Acquisition,#MIS-Reports-photoBilling,#Cash_Collection').removeClass('start active ,selected');
   	    	   });
