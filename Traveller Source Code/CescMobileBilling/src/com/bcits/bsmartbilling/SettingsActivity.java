...
public class SettingsActivity extends Activity{
	...
	ToggleButton   toggle_btn_autoupdate , wifi_toggleButton , enablephoto_toggleButton, enablegps_toggleButton;
	Button btnlogout , btn_summary_report , btn_detailed_reports , btn_device_manager;
	TextView txt_Versionupdae, btn_batteryUsage;
	Logger logger ;
	byte[] img=null;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	headerIcon = (ImageView)findViewById(R.id.header);
	 ...
	 btn_batteryUsage = (TextView)findViewById(R.id.btn_batteryUsage);
...
protected void onStart() {
	...
	btn_batteryUsage.setOnClickListener(new OnClickListener() {
