...
public class PrintBillAction extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		requestWindowFeature(Window.FEATURE_CUSTOM_TITLE);
		 ...
		 btn_backpress = (Button)findViewById(R.id.titleBack);
	        ...
	        title.setText(getString(R.string.cus_title_name)+MasterLibraryFunction.getVersion(PrintBillAction.this));
	             ...
	             .setMessage("Consumer details is not correct or unable to bill , Please try again later ")
	                 .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
	                     public void onClick(DialogInterface dialog, int id) {
	                    	 ...
	                    	 Intent nfData_intnt = new Intent(PrintBillAction.this,MainActivity.class);
		...
		btn_next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(  (!UtilMaster.mGLogin_SiteCode.trim().equalsIgnoreCase("")) && (!UtilMaster.mGLogin_MRCode.trim().equalsIgnoreCase("")) )
				{
					...
					libraryFunction = new  MasterLibraryFunction(PrintBillAction.this) ;
					if (libraryFunction.isdataValid()) {
						...
						if(isBillNormalNew(billDemand, ec , units , UtilMaster.getMtariff().trim())	)	{
							
							startActivity(new Intent(PrintBillAction.this, BluetoothChat.class));
							
						}
						
						else{
							
							FilePropertyManager.appendLog(" Abnormal billDemand: "+billDemand);
							UtilMaster
							.show(PrintBillAction.this,
									"Sorry..!",
									0,
									"Abnormal bill Not Allowed Bill Demand: "+billDemand +"\nEC: "+ec +"\nUnits: "+units +"\nBill will be cancelled",
									"OK",
									getDialogListener(PrintBillAction.this,	SearchActivity.class)).setCancelable(false).show();
						}
	...
	public boolean isBillNormal(double billDemand, float ec , float units  ,String tCode) {
	...
	private void clearBill() {
		...
		.setPositiveButton("Yes Cancel",
				...
				.show();
		/*AlertDialog.Builder builder =	UtilMaster.show(PrintBillAction.this, "Info", 0, "Do you want to Cancel bill?", "Yes Cancel",getDialogListener(PrintBillAction.this, SearchActivity.class),  "No" , null);
		finish();
		builder.show() ;*/
	}
