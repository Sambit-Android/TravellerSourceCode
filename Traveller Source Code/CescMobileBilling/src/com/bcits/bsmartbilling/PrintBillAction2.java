...
public class PrintBillAction2 extends AmrHardWareWatcher {

	static Logger logger;
	private static String TAG = "PrintBillAction";
	private Button btn_next, btn_backpress;
	MasterLibraryFunction libraryFunction;
	TextView title, txtprtReading, txtConsuption, txtEc, txtFC, txtarrears,txtTotalA;

	TextView txtConsumerNo,txtName,txtAddress,txtTariff,txtPreviousReading;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_printpreview_new);
		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE,R.layout.window_title);

		txtConsumerNo=(TextView)findViewById(R.id.txtConsumerNo);
		...
		title.setText(getString(R.string.cus_title_name)
				+ MasterLibraryFunction.getVersion(PrintBillAction2.this));
		...
		if (!UtilMaster.mGLogin_SiteCode.trim().equalsIgnoreCase("")
			...
			new AlertDialog.Builder(PrintBillAction2.this)
					.setTitle("Error")
							...
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									Intent int_login = new Intent(
											PrintBillAction2.this, Login.class);
	...
	private void setConsDetails(){
		try {
		
		txtName.setText(UtilMaster.mconsumer_name) ;
		txtConsumerNo .setText(UtilMaster.mconsumer_sc_no);
		if(UtilMaster.maddress.trim().equals("")
			...
			txtAddress.setText(UtilMaster.maddress);
		}
	...
	protected void onStart() {
		...
		btn_next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if ((!UtilMaster.mGLogin_SiteCode.trim().equalsIgnoreCase(""))	&& (!UtilMaster.mGLogin_MRCode.trim().equalsIgnoreCase(""))) {

					libraryFunction = new MasterLibraryFunction(PrintBillAction2.this);
					if (libraryFunction.isdataValid()) {
						...
						try {
							...
							billDemand = Float.parseFloat(UtilMaster.getMtax().trim())
									+ Float.parseFloat(UtilMaster.getMec().trim())
									+ Float.parseFloat(UtilMaster.getMfc().trim())
									+ Float.parseFloat(UtilMaster.getMothers().trim())
									+ Float.parseFloat(UtilMaster.getMinterest().trim())
									- Float.parseFloat(UtilMaster.getMcredit_or_rebate().trim())
									- Float.parseFloat(UtilMaster.getMdl_adj().trim());
							...
							UtilMaster
									.show(PrintBillAction2.this,
											"Error",
											0,
											"Sorry..! \nSession expired please Login again",
											"OK",
											getDialogListener(
													PrintBillAction2.this,
													Login.class)).show();
						}
						...
						{
							startActivity(new Intent(PrintBillAction2.this,
									BluetoothChat.class));
						}
						...
						UtilMaster
								.show(PrintBillAction2.this,
										...
										"OK",
										getDialogListener(PrintBillAction2.this,
